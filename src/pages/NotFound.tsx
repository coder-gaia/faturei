  ...
  return (
    <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 24, background: 'var(--color-bg)' }}>
      ...
      >
        ...
        <h1 style={{ fontSize: 24, fontWeight: 700, color: 'var(--color-white)', marginBottom: 10 }}>Página não encontrada</h1>
        <p style={{ color: 'var(--color-gray-2)', fontSize: 15, marginBottom: 32, lineHeight: 1.6 }}>
